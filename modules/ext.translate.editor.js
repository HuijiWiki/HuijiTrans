( function ( $, mw ) {
    ...
    TranslateEditor.prototype = {
        ...
        footerColumn: function(){
            var $footer = $('<div>').addClass('footer-column clear'),translateEditor = this,$messageDescViewer = $( '.message-desc-viewer' ),
                $messageDescSaveButton,$messageDescCancelButton,$messageDescTextarea,$messageDescEditor;
            ...
            if ( mw.config.get( 'wgTranslateDocumentationLanguageCode' ) ) {
                ...
                $messageDescEditor = $('<div>')
                    .addClass('message-desc-editor hide')
                    .append(
                    $messageDescTextarea,
                    $('<div>')
                        .addClass('row')
        ...
        prepareEditorColumn: function () {
            var translateEditor = this,
                ...
                $messageDescEditor, $messageDescTextarea,
                $messageDescSaveButton, $messageDescCancelButton,
                $messageDescViewer,$transHistory;
            ...
            $transHistory = $( '<a>' )
                .addClass( 'icon-clock history-btn hide' )
                .on('click', $.proxy( this.showHistory, this) );
                ...
                $messageDescViewer = $( '<div>' )
                    ...
                    $( '<div>' )
                        ...
                        .append( $( '<a>' )
                            ...
                            .addClass( 'message-desc-edit icon-pencil' )
    ...
    var translateEditorHelpers = {
        ...
        showDocumentationEditor: function () {
            var $infoColumnBlock = this.$editor.find( '.infocolumn-block' ),
                ...
                $messageDescEditor = this.$editor.find( '.message-desc-editor' ),
                $messageDescViewer = this.$editor.find( '.message-desc-viewer' );

            if($messageDescEditor.hasClass('hide')){
...
//            $messageDescViewer.addClass( 'hide' );
        ...
        saveDocumentation: function () {
            ...
            return api.postWithToken( 'edit', {
                ...
                var $messageDesc = translateEditor.$editor.find( '.message-desc' );
                var $intro = translateEditor.$editor.find('.intro');
...
//                console.log(translation);
        ...
        addHistory: function ( history ) {
            ...
            var $history;
            $history = $('<div>')
                .addClass('editor-history hide')
                .append(
                    $('<span>')
                        .addClass('history-title')
                        .text('历史'),
                    history.html
                );
            this.$editor.find('.footer-column').append($history);

            this.$editor.find('.history-btn').removeClass('hide');

        },
        showHistory: function () {
            console.log(this.$editor);
            this.$editor.find('.editor-history').toggleClass('hide');
...
//                console.log(result);
                ...
                translateEditor.addHistory( result.helpers.history);
